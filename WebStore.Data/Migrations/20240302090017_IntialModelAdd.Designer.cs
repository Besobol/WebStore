...
namespace WebStore.Infrastructure.Migrations
{
    ...
    [Migration("20240302090017_IntialModelAdd")]
    partial class IntialModelAdd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.AuthorBook", b =>
                {
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.GenreBook", b =>
                {
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.Publisher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.PublisherBook", b =>
                {
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.Store", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.StoreBook", b =>
                {
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.AuthorBook", b =>
                {
                    b.HasOne("WebStore.Infrastructure.Models.Author", "Author")
                        .WithMany("AuthorsBooks")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebStore.Infrastructure.Models.Book", "Book")
                        .WithMany("AuthorsBooks")
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.GenreBook", b =>
                {
                    ...
                    b.HasOne("WebStore.Infrastructure.Models.Genre", "Genre")
                        .WithMany("GenresBooks")
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.PublisherBook", b =>
                {
                    ...
                    b.HasOne("WebStore.Infrastructure.Models.Publisher", "Publisher")
                        .WithMany("PublishersBooks")
            ...
            modelBuilder.Entity("WebStore.Infrastructure.Models.StoreBook", b =>
                {
                    ...
                    b.HasOne("WebStore.Infrastructure.Models.Store", "Store")
                        .WithMany("StoresBooks")
